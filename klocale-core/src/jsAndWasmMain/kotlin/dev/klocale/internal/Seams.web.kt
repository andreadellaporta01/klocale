...
private class OrdinalWebFormatter(private val localeTag: String) : PlatformFormatter {
    override fun format(value: DecimalInput): String {
        ...
        val suffix =
            when (ordinalCategory(localeTag, n.toDouble())) {
                "one" -> "st"
                "two" -> "nd"
                "few" -> "rd"
                else -> "th"
...
internal expect fun ordinalCategory(
    locale: String,
    n: Double,
): String
...
internal expect fun intlRelative(
    locale: String,
    numeric: String,
    style: String,
    unit: String,
...
private fun intlUnit(unit: MeasureUnit): String =
    when (unit) {
...
private fun SignDisplay.toIntl(): String =
    when (this) {
...
private fun RoundingMode.toIntl(): String =
    when (this) {
...
internal expect fun intlFormat(
    locale: String,
    optionsJson: String,
    value: Double,
): String

internal expect fun intlFormatString(
    locale: String,
    optionsJson: String,
    value: String,
): String
