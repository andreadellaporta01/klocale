...
internal actual fun intlFormat(locale: String, optionsJson: String, value: Double): String =
    js("new Intl.NumberFormat(locale, JSON.parse(optionsJson)).format(value)")

internal actual fun intlFormatString(locale: String, optionsJson: String, value: String): String =
    js("new Intl.NumberFormat(locale, JSON.parse(optionsJson)).format(value)")
...
internal actual fun ordinalCategory(locale: String, n: Double): String =
    js("new Intl.PluralRules(locale, { type: 'ordinal' }).select(n)")

internal actual fun intlRelative(locale: String, numeric: String, style: String, unit: String, value: Double): String =
